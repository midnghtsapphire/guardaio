          ...
          {history.length > 0 && (
            <div className="mb-8">
              <button
                ...
                className="w-full flex items-center justify-between glass rounded-xl px-4 py-3 mb-4 hover:bg-card/60 transition-colors group"
              >
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center">
                    <BarChart3 className="w-4 h-4 text-primary" />
                  </div>
                  <span className="font-medium">Statistics Dashboard</span>
                </div>
                <ChevronDown 
