...
const publications: Publication[] = [
  ...
  // Case Studies
  {
    ...
    abstract: "Case study of Guardaio's deployment at a major news organization during breaking news events. Includes workflow integration, accuracy metrics, and journalist feedback.",
    authors: ["Guardaio Research Team"],
    date: "2026-01-08",
    type: "case-study",
    pages: 12,
    downloadUrl: "#",
  ...
  },
  {
    ...
    abstract: "A Fortune 500 bank reduced synthetic identity fraud by 94% using Guardaio's API integration. Detailed implementation guide and results analysis.",
    authors: ["Guardaio Enterprise Team"],
    date: "2025-11-30",
    type: "case-study",
    pages: 16,
    downloadUrl: "#",
  ...
  },
  {
    ...
    abstract: "How three political campaigns used Guardaio to monitor and respond to deepfake attacks during the 2024 election cycle.",
    authors: ["Guardaio Security Team"],
    date: "2025-02-15",
    type: "case-study",
    pages: 20,
    downloadUrl: "#",
  ...
  {
    id: "td-1",
    title: "Guardaio API v2.0 Technical Specification",
    abstract: "Complete technical documentation for the Guardaio API including endpoints, authentication, rate limits, error handling, and code examples in 6 languages.",
    authors: ["Guardaio Engineering"],
    date: "2026-01-20",
    type: "technical",
    pages: 64,
    downloadUrl: "#",
  ...
  },
  {
    ...
    abstract: "Technical deep-dive into Guardaio's multi-model detection architecture, including the ensemble approach and confidence scoring methodology.",
  ...
  // Guides
  {
    ...
    authors: ["Guardaio Education Team"],
    date: "2025-12-01",
    type: "guide",
    pages: 24,
    downloadUrl: "#",
  ...
  },
  {
    ...
    authors: ["Guardaio Legal Team", "External Counsel"],
    date: "2025-09-15",
    type: "guide",
    pages: 32,
    downloadUrl: "#",
